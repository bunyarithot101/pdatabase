...
import com.bbbdev.pokebase.databinding.FragmentNotFoundBinding
...
//        return inflater.inflate(R.layout.fragment_not_found, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val textError = arguments?.getString("error")
        binding.error.text = textError.toString() + getString(R.string.error).toString()
